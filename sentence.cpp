...
// PROPERTIES
std::string sentence::talker() const { return sentence::m_talker; }
std::string sentence::type() const { return sentence::m_type; }
uint8_t sentence::field_count() const { return sentence::m_fields.size(); }
