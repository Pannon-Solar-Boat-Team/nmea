...
// BASE
void nmea::parse_int8(nmea::field<int8_t>& field, const nmea::sentence& sentence,
                      uint8_t field_index) {
    // Get field string.
...
void nmea::parse_uint8(nmea::field<uint8_t>& field, const nmea::sentence& sentence,
                       uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
...
void nmea::parse_uint16(nmea::field<uint16_t>& field, const nmea::sentence& sentence,
                        uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
...
void nmea::parse_float(nmea::field<float>& field, const nmea::sentence& sentence,
                       uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
...
// EXTENDED
void nmea::parse_utc(nmea::field<double>& field, const nmea::sentence& sentence,
                     uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
...
void nmea::parse_date(nmea::field<nmea::date>& field, const nmea::sentence& sentence,
                      uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
...
void nmea::parse_latitude(nmea::field<double>& field, const nmea::sentence& sentence,
                          uint8_t field_index) {
    // Get field strings.
...
void nmea::parse_longitude(nmea::field<double>& field, const nmea::sentence& sentence,
                           uint8_t field_index) {
    // Get field strings.
...
void nmea::parse_status(nmea::field<nmea::status>& field, const nmea::sentence& sentence,
                        uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
...
void nmea::parse_mode(nmea::field<nmea::mode>& field, const nmea::sentence& sentence,
                      uint8_t field_index) {
    // Get field string.
    std::string field_string = sentence.get_field(field_index);
