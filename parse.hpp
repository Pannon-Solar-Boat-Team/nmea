...
/// \param sentence The NMEA sentence to read the value from.
/// \param field_index The index of the field in the NMEA sentence.
void parse_uint16(nmea::field<uint16_t>& field, const nmea::sentence& sentence,
                  uint8_t field_index);
...
void parse_enum(nmea::field<enum_type>& field, const nmea::sentence& sentence,
                uint8_t field_index) {
    // Get field string.
...
/// \param sentence The NMEA sentence to read the value from.
/// \param field_index The index of the field in the NMEA sentence.
void parse_date(nmea::field<nmea::date>& field, const nmea::sentence& sentence,
                uint8_t field_index);
/// \brief Parses latitude from an NMEA sentence.
/// \param field The NMEA field to parse the value into.
/// \param sentence The NMEA sentence to read the value from.
/// \param field_index The index of the field in the NMEA sentence.
void parse_latitude(nmea::field<double>& field, const nmea::sentence& sentence,
                    uint8_t field_index);
/// \brief Parses longitude from an NMEA sentence.
/// \param field The NMEA field to parse the value into.
/// \param sentence The NMEA sentence to read the value from.
/// \param field_index The index of the field in the NMEA sentence.
void parse_longitude(nmea::field<double>& field, const nmea::sentence& sentence,
                     uint8_t field_index);
/// \brief Parses a status from an NMEA sentence.
/// \param field The NMEA field to parse the value into.
/// \param sentence The NMEA sentence to read the value from.
/// \param field_index The index of the field in the NMEA sentence.
void parse_status(nmea::field<nmea::status>& field, const nmea::sentence& sentence,
                  uint8_t field_index);
/// \brief Parses a mode from an NMEA sentence.
/// \param field The NMEA field to parse the value into.
/// \param sentence The NMEA sentence to read the value from.
/// \param field_index The index of the field in the NMEA sentence.
void parse_mode(nmea::field<nmea::mode>& field, const nmea::sentence& sentence,
                uint8_t field_index);
